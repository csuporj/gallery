...
Known bugs:
- Resizing the window when you are on the 3rd+ row is flickering, because the grid and scrollbar are hidden during zoom and resize. This is done to hide the scrollbar jumping around during zoom and resize.
